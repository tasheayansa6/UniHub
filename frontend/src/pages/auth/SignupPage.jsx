...
export default function SignupPage() {
  ...
  useEffect(() => {
    ...
    if (document.getElementById('google-gsi-script')) { init(); return; }
        ...
        <div className="flex-1 p-8 flex flex-col justify-center">
          ...
          <div className="mt-4 space-y-3">
            ...
            {import.meta.env.VITE_GOOGLE_CLIENT_ID && import.meta.env.VITE_GOOGLE_CLIENT_ID !== 'your-google-client-id-here' ? (
              ...
              <div className="w-full h-11 rounded-xl border border-gray-200 flex items-center justify-center gap-3 text-sm font-medium text-gray-400 cursor-not-allowed opacity-60">
                ...
                Sign up with Google (configure Client ID)
              </div>
            )}
